...
public class ManagerCarSourceActivity extends BaseListActivity implements
    ...
    private void initViews() {
        ...
        // 初始化CarInfoListAdapter的adapter
        mAdapter = new CarInfoListAdapter(mContext);
    ...
    protected void onResume() {
        super.onResume();
        LogUtil.d("ybxiang", "mAdapter.isEmpty()==" + mAdapter.isEmpty());
        if (mAdapter.isEmpty()) {
            pageIndex = 1;
            getData(pageIndex);
        }
...
//            CarInfo carInfo1 = new CarInfo("四川-重庆","10吨","高栏");
//            CarInfo carInfo2 = new CarInfo("成都-重庆","10吨","高栏");
//            CarInfo carInfo3 = new CarInfo("上海-重庆","10吨","特种");
//            CarInfo carInfo4 = new CarInfo("山西-重庆","8吨","高平板");
//            result.add(carInfo1);
//            result.add(carInfo2);
//            result.add(carInfo3);
//            result.add(carInfo4);
...
//                    ((CarInfoListAdapter) mAdapter).addAll(mList);
//                    mAdapter.notifyDataSetChanged();
//                }
//            }
}
