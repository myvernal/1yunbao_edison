 ...
 */
public class VenderShopDetailActivity extends BaseListActivity implements OnScrollListener {
	...
	private void initListener() {
		btnDianpin.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				Intent intent = new Intent(VenderShopDetailActivity.this, com.maogousoft.logisticsmobile.driver.activity.vip.EvaluateActivity.class);
